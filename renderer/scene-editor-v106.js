/* v1.0.106 — tactical Scene Editor */
(() => {
  'use strict';
  if (window.__grpgSceneEditorV105 || typeof Combat === 'undefined') return;
  window.__grpgSceneEditorV105 = true;
  ...
  function hexGridSvg(scene) {
    ...
    const side=.42, hexH=Math.sqrt(3)*side, stepX=side*1.5;
    const paths=[];
