...
assert.match(index, /APP: v1\.0\.132/);
assert.match(index, /styles\.css\?v=1\.0\.132/);
assert.match(index, /app\.js\?v=1\.0\.132/);
assert.match(index, /region-command-center\.js\?v=1\.0\.128/);
assert.match(displayHtml, /player-display\.js\?v=1\.0\.128/);

console.log('v1.0.127 maximal Lite performance checks passed');
